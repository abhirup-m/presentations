...
\begin{frame}{Acknowledgements}
	\flushleft
	\hspace*{20pt}
	\focus{Collaborators}: Prof. S. R. Hassan, Prof. Anamitra Mukherjee, Prof. N S Vidhyadhiraja, Prof. A Taraphder\\
	\hspace*{20pt}
...
\begin{minipage}{0.49\textwidth}
\begin{itemize}
	\item Development of auxiliary model-based method for interacting electrons [{\bf arXiv}:2507.xxxxx].
\end{itemize}
\end{minipage}
\begin{minipage}{0.49\textwidth}
\begin{itemize}
...
% \vspace*{\fill}
\centering
\includegraphics[width=0.5\textwidth]{blackHoleModel.pdf}
\includegraphics[width=0.45\textwidth]{blackhole.pdf}
\end{frame}
...
\section{A New Auxiliary Model Approach to Systems of Interacting Electrons}
