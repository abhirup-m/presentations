...
\begin{itemize}
	\only<+>{
		\item Take diagonal matrix element \(\bra{\tilde i}G^{-1}\ket{\tilde i}\). On the RHS, there are \(w\) terms that have the index \(i\). Because of translational invariance, all such terms will be same.
	\begin{equation*}
