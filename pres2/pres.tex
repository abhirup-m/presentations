...
\vspace*{30pt}
\begin{center}
\head{Unitary Renormalization Group Approach to the Anderson model}
	\vspace*{70pt}
...
\Large{
\item\bf{The single-impurity Anderson model}
...
\head{Single-Impurity Anderson Model}

\beq
\mathlarger{\pmb{\ham = \underbrace{\textcolor{blue}{\sum_{k\sigma}\epsilon_k \hat n_{k\sigma}}}_{\text{hopping term}} + \overbrace{\textcolor{brown}{U\sum_i\hat{n}_{i\uparrow}\hat{n}_{i\downarrow}}}^{\text{Hubbard term}}}}
\eeq
