...
\begin{frame}{Unitary Renormalization Group: Overview}
...
\end{figure}}
\end{frame}
\begin{frame}{URG: Salient Features}
\vspace*{\fill}
\begin{itemize}
...
\begin{frame}{URG: Relation to Poor Man's Scaling}
	\vspace*{-50pt}
	\begin{center}
...
\end{frame}
\begin{frame}{URG: Relation to Continuous Unitary Transformation RG}
...
\begin{frame}{Results: Relation between \(R\) and \(\Delta V_L\)}
