...
\begin{frame}{Exact Diagonalisation and Correlation Functions}
	\begin{itemize}
		\item Lot of experience working with \focus{fermionic hamiltonians}
	...
	\begin{itemize}
		\item Spin/charge-correlation
		\item Order parameters
	\end{itemize}
	\vspace{1.3em}
	\includegraphics[width=0.8\textwidth]{sdz_77-1500.pdf}
	\end{minipage}
	\begin{minipage}{0.32\textwidth}
	\centering
	...
	\end{itemize}
	\includegraphics[width=0.8\textwidth]{Ad_zoomin_77-1500.pdf}
	\end{minipage}
	\begin{minipage}{0.32\textwidth}
	\centering
	...
	\end{itemize}
	\includegraphics[width=0.8\textwidth]{qfi_77-2000.pdf}
	\end{minipage}
...
\begin{frame}{Miscellaneous methods}
	\begin{itemize}
		\item Spectral flow insertion techniques
		\item Effective Hamiltonian computation
	\end{itemize}
	\vfill
	Interested in learning \focus{new methods} as well: \focus{DMRG, NRG, DMFT}, etc
	\vfill
