...
\subtitle{Postdoctoral Presentation at IoP, AS}
...
\begin{frame}{A Brief Introduction}
	...
	\begin{itemize}
		\item \focus{Mott transition} and criticality, Kondo breakdown in heavy-fermion systems
		\item Unconventional superconductivity
		\item emergent non-Fermi liquid phases, \focus{orbital/band-selective} transitions, and Fermi surface topology change
...
\begin{itemize}
	\item[\ding{51}] {\bf Mott Criticality as the Confinement Transition of a Pseudogap-Mott Metal}. New J. Physics (in press) (2026)\\[10pt]
...
\subsection{\large New J. Physics (in press) (2026). Abhirup Mukherjee, S R. Hassan, A Mukherjee, N S. Vidhyadhiraja, A Taraphder, S Lal}
...
\begin{itemize}
	\item real-space correlations \(\langle S_d\cdot S_r \rangle \) and entanglement undergo a crossover within the pseudogap from short-ranged to \focus{long-ranged} behaviour\\[10pt]
