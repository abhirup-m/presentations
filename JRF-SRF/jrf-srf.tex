...
\title{\vspace*{\fill}Local metal-insulator transition in an extended Anderson impurity model}
...
\begin{itemize}
\item Lee et. al show \alert{peaks} in doublon-holon correlators near zero energy within the central peak.\\[5pt]
\begin{center}
\includegraphics[width=0.75\textwidth]{doublon-holon-correlators.pdf}\\[5pt]
\end{center}
\item We find support for this in the form of \alert{increasing ground-state charge correlations and overlap}.\\[5pt]
