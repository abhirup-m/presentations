...
\only<2>{
	...
	\[U_0 + U_b \simeq J > 0\]
\nitem \(J\) acts a \alert{symmetrisation mechanism} between impurity and zeroth sites
\begin{center}
...
\begin{minipage}{0.45\textwidth}
\nitem spectral function shows preformed gap from metallic side
\end{minipage}
\hspace*{\fill}
\begin{minipage}{0.45\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{pre-gap.pdf}\\[10pt]
\end{center}
\end{minipage}
