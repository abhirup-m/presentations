...
\titlegraphic{
	\vspace{10pt}
	\hfill \includegraphics[width=0.4\textwidth]{cover.pdf}\\
	\vspace{-20pt}
...
\begin{frame}{A Bottom-Up Approach: Starting from an Impurity Model}
	...
	\begin{itemize}[<+->]
		...
		\item Conduction \alert{bath} is mostly non-interacting, except for local correlation on sites \alert{adjacent to impurity}
	...
	\begin{minipage}{0.4\textwidth}
		\only<5>{\vspace*{-10pt}\includegraphics[width=0.3\textwidth]{translation.pdf}
		}
		\hfill
...
\begin{frame}{Momentum-space Resolved Impurity Phase Transition}
	...
	\only<4-5>{\includegraphics[width=\textwidth]{cupratesMI.pdf}}
	\end{minipage}

	\includegraphics[width=0.2\textwidth]{pWaveEsiam2.pdf}
	\hspace*{\fill}
	\only<2>{
