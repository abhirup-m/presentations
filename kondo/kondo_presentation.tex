...
\only<+>{
	...
	\[\hspace*{-10pt} T_K = \frac{\hbar v_{F}\Lambda_{0}}{k_{B}}\exp\left(\frac{1}{2n(0)}-\frac{1}{n(0)K_{0}}-\frac{K_{0}}{n(0)16}\right), ~ ~ \xi_K = \frac{h v_F}{k_B \xi_K}\]
...
\only<+>{
	\head{\(\chi \times T\) and thermal entropy via zero-bandwidth model}
