...
\begin{frame}[noframenumbering]{The Unitary Renormalization Group: Overview}

\centering
\textbf{\large The General Idea}\\[10pt]
\only<1-3>{
...
\end{frame}
\begin{frame}[noframenumbering]{The Unitary Renormalization Group: Formalism}
\centering
\only<+>{
\large{\textbf{Step 1: Select a UV-IR Scheme}}
\vspace*{\fill}

\begin{minipage}{0.5\textwidth}
\centering
\(k_N \equiv \text{UV state}\)\\
\(\cdot\)\\
\(\cdot\)\\
\(k_j\)\\
\(\cdot\)\\
\(\cdot\)\\
\(k_1 \equiv \text{IR state (Fermi surface)}\)
\end{minipage}
\hspace*{\fill}
...
\only<+>{
\large{\textbf{Step 1: Select a UV-IR Scheme}}
\begin{minipage}{200pt}Start with the electrons farthest from the Fermi surface. Write the Hamiltonian as \textit{diagonal and off-diagonal terms} in this basis.\end{minipage}\begin{minipage}{300pt}
	\begin{figure}
...
\begin{frame}[noframenumbering]{The Unitary Renormalization Group: Salient Features}
\vspace*{\fill}
\begin{itemize}[<+-|alert@+>]
