...
\only<+>{\centering
	...
	supplement usual 1-particle hybridisation with \focus{spin- and charge-excitations}
...
\begin{itemize}[<+-|alert@+>]
\item Resistance of metal \focus{reveals non-monotonicity} at low \(T\) - owing to \focus{spin-flip scattering}\\[10pt]
\item "Poor Man's scaling" \& numerical RG showed - spin-exchange coupling \focus{renormalises to \(\infty\)}\\[10pt]
...
\begin{minipage}{0.3\textwidth}
	\only<2>{\includegraphics[width=\textwidth]{figures/kondo_res_schematic.pdf}}
	\only<3-4>{\includegraphics[width=\textwidth]{figures/cloud_lFL.pdf}}
	\only<5-6>{\includegraphics[width=\textwidth]{figures/chi_schematic.pdf}}
...
\begin{frame}[noframenumbering]{URG of the Generalised SIAM}
	\only<1>{\head{RG Equation}}
	\only<2>{\head{RG flows and fixed points}}
	\only<3>{\head{Phase diagram}}
	\only<4>{\head{Kondo cloud length \(\xi_K\)}}
	\only<5>{\head{Kondo temperature \(T_\mathrm{K}\)}}
	\only<6>{\head{Fixed point Hamiltonian}}
	\only<7>{\head{Approach towards the continuum}}
...
\only<+>{
\[K_{(j)} = J_{(j)}\left(\omega_{(j)} - \frac{1}{2}D_{(j)}\right)^{-1}, ~ ~ K^* = 4\]
...
\only<+>{
	...
	\includegraphics[width=0.8\textwidth]{figures/Jstar_Xik.pdf}
}
\only<+>{
	\centering
	Exponential growth of \(T_K\) at \focus{low \(J\)}
	
	\vspace*{10pt}
	\includegraphics[width=0.8\textwidth]{figures/TK.pdf}
	\vspace*{-20pt}
}
\only<+>{
...
\only<5>{\footcite{wilson1975,hrk_wilson_1980,haldane1978scaling,martin2019}}
\only<7>{\footcite{wilson1975}}
...
\centering
\only<3>{
	\(\left(\chi\times T\right)\bigg\vert_{T \to \infty} = \frac{1}{4}\), ~ ~ \focus{Curie paramagnetism}
...
\begin{frame}[noframenumbering]{Effective Hamiltonian for the Kondo Cloud}
	...
	\only<+->{	\item Restore the kinetic energy part:
			...
			\[H^* = \underbrace{\sum_{k < k^*,\sigma}\epsilon_{k}\hat{n}_{k\sigma}}_{H_0^*} ~ + ~ J^* \vec{S}_d\cdot \vec{s}_< = \underbrace{\sum_{k < k^*,\sigma}\epsilon_{k}\hat{n}_{k\sigma} ~ + ~ J^* S_d^z s_<^z}_{H_D} ~+~ \underbrace{J^*{S}_d^+ {s}_<^- + \text{h.c.}}_{V ~+~ V^\dagger}\]}
...
{
\centering
\includegraphics[width=0.3\textwidth]{figures/par-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\hspace*{\fill}
\includegraphics[width=0.3\textwidth]{figures/gap-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\hspace*{\fill}
\includegraphics[width=0.3\textwidth]{figures/lfl-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
}
...
\begin{center}
\includegraphics[width=0.4\textwidth]{figures/mi-dk-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\hspace*{\fill}
\includegraphics[width=0.4\textwidth]{figures/corr-k-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\end{center}
}
...
\begin{center}
\includegraphics[width=0.4\textwidth]{figures/corr-k-diag-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\hspace*{\fill}
\includegraphics[width=0.4\textwidth]{figures/corr-k-od-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\end{center}
}
\end{frame}
...
\begin{center}
\includegraphics[width=0.4\textwidth]{figures/EE-d-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\end{center}
}
\only<+>{
...
\begin{center}
\includegraphics[width=0.4\textwidth]{figures/r1p-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\hspace*{\fill}
\includegraphics[width=0.4\textwidth]{figures/r-od-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\hspace*{\fill}
\end{center}
}
\only<+>{
...
\begin{center}
\includegraphics[width=0.4\textwidth]{figures/r-par-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\hspace*{\fill}
\includegraphics[width=0.4\textwidth]{figures/r-ising-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\hspace*{\fill}
\end{center}
}
\only<+>{
...
\hspace*{\fill}
\includegraphics[width=0.4\textwidth]{figures/corr-di-max-t=1.000,J=1_over_U,V=J,N=4,U=0.010,100.000,100.pdf}
\hspace*{\fill}
\end{center}
}
\end{frame}
