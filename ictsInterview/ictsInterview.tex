...
\begin{frame}{A Brief Introduction}
	...
	\begin{itemize}
		...
		\item \focus{Numerical computation} of correlation functions, entanglement measures, dynamical correlations (spectral function, self-energy, etc)
		\item Developed \focus{new method} for using impurity models to analyse interacting lattice models
		\item Developed Python and Julia \focus{libraries} for fermionic Hamiltonian analysis
	\end{itemize}
\end{frame}
